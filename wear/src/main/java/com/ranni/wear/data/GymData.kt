...
// Duplicated from :app GymData.kt — update both files if gym/route data changes.
// hollowDots and needsContrastRing are omitted as they are not used in the watch UI.
...
// Route lookup keyed by (gymName, routeName) — used by WearListenerService on the phone side
// to verify the route exists. Not needed on the watch UI itself but kept for completeness.
